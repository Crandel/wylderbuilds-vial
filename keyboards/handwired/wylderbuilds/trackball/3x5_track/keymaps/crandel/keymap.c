...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+-------------+-------------+-------------+--------|    |-------------+----------------+----------------+---------------+--------|
    KC_BTN4,         KC_8,         KC_5,         KC_1,    KC_3,           KC_LEFT,         KC_DOWN,           KC_UP,       KC_RIGHT,   TD(1),
  //|------+-------------+-------------+-------------+--------|    |-------------+----------------+----------------+---------------+--------|
    KC_BTN5,         KC_9,         KC_6,         KC_0, KC_BTN2,             KC_F1,           KC_F2,           KC_F3,          KC_F4, KC_BSLS,
  //|------+-------------+-------------+-------------+--------|    |-------------+----------------+----------------+---------------+--------|
                                              KC_LGUI,  KC_SPC,                             KC_ENT,
                                       // -----------+-- -----|    |-------------+----------------|
                                              KC_BTN1,   TD(0),                            KC_BSPC,
                                       // -----------+--------|    |-------------+----------------|
                                               KC_DEL, QK_GESC,           KC_QUOT,          KC_TAB
                                       // -----------+--------|    |-------------+----------------|
  ),
